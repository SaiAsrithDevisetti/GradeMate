                ...
                <center>
                    ...
                    <div class="input_field">
                        ...
                        <p>Choose your options:</p>
                            <label><input type="radio" name="True" value="True" onChange={handleInput}/>True</label><br/>
                            <label><input type="radio" name="False" value="False" onChange={handleInput}/>False</label><br/>


                        {/* <input type="text" className="input" id="answer" name="answer"value={answer} onChange={handleInput}></input>     */}
                    </div>
